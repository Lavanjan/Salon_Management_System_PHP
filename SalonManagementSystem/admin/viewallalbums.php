...
$sql = "select * from tbl_album where status='process' ORDER BY albumid DESC LIMIT $start_from, 10";
...
<thead>
                                        <tr>
                                            ...
                                            <th>Images(Can Update)</th>
											<th colspan=2 width="18%">(Delete & Edit)</th>
...
echo "<a href='viewallalbums.php?page=".$i."' class='pagination justify-content-center'>".$i."</a> ";
};
?>
