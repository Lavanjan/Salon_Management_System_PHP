...
mysqli_query($connection,"update prod_gallery set name='$price',prod_desc='$adesc' where gid = '$mykey1'");
echo "<script>location.href='prod_viewsgimages.php'</script>";
                                ...
                                <div class="col-lg-6">
                                    <form action="#" method="post" enctype="multipart/form-data" name="upload">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Enter Title" name="price" value="<?php echo $mykey2 ?>">
                                       ...
                                       <div class="form-group">
                                            ...
                                            <label>Product Description</label>
                                             ...
                                             <textarea class="form-control" rows="3" placeholder="Enter Description" name="prod_desc" maxlength="1000"><?php echo $mykey3 ?></textarea>
