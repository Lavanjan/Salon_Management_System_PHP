...
<head>
    ...
    <title>Northern Stylish | Admin Login</title>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title" align="center"> Please SignIn</h3>
                    </div>
...
include "connect.php";
$result = mysqli_query($connection ,"select * from admin where username = '$myuser' and password='$mypass'");
