...
imagedestroy($src);
imagedestroy($tmp); // PHP will clean up the temp file it created when the request
// has completed.
...
mysqli_query($connection,"update prod_album set image='$photo' where albumid = '$mykey1'");
