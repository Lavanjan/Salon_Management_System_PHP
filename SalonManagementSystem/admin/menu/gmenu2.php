        ...
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <?php if (isset($_SESSION['uname'])) { ?>
                                <a class="active" href="viewsgallery.php">View Gallery</a><?php } ?>
                        </li>
                    </ul>
                    <!-- /.nav-second-level -->
                </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li><?php if (isset($_SESSION['uname'])) { ?>
                                <a href="prod_addalbum.php">Add Album</a><?php } ?>                                </li>
                        <li><?php if (isset($_SESSION['uname'])) { ?>
                                <a class="active" href="prod_viewallalbums.php">View Album</a><?php } ?>
                        </li>
                    </ul>
                    <!-- /.nav-second-level -->
                </li>
                ...
                <li><?php if (isset($_SESSION['uname'])) { ?>
                    <a href="view_message.php"><i class="fa fa-comment"></i> Customers Messages</a><?php } ?>
                </li>
