...
if (isset($_SESSION['uname'])) {
    ...
    <?php include "menu/alprod_menu.php"; ?>
    ...
    <div id="page-wrapper">
        ...
        <script type="application/javascript">
            function img_up() {
                ...
                if (ext == "JPEG" || ext == "jpeg" || ext == "jpg" || ext == "JPG") {
                    ...
                    alert("only jpeg format supported!");
                    fup.focus();
                    return false;
                }
            }</script>
        ...
        if (isset($_POST['submit'])) {
            ...
            $filename = "prod_acatch/" . $rd . $_FILES['upload']['name'];
            imagejpeg($tmp, $filename, 100);

            imagedestroy($src);
            imagedestroy($tmp);
            $photo = $rd . $_FILES['upload']['name'];
            move_uploaded_file($_FILES["upload"]["tmp_name"], "prod_aupload/" . $rd . $_FILES["upload"]["name"]);
            ...
            if (empty($aname)) {
                ...
                $query = "INSERT INTO prod_album(name,adesc,image,date,status) VALUES ('$aname','$adesc','$photo','$adate','$status')";
                if (mysqli_query($connection, $query)) {
                    echo " <div class='alert alert-success'>Your New Album Is Successfully Added. <a href='prod_viewallalbums.php'>View albums</a> |<a href='addevent.php'> Add new album</a></div>";
                } else {
                    echo "error";
                                ...
                                <form action="#" method="post" enctype="multipart/form-data" name="upload">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="3" placeholder="Enter Description"
                                                  name="adesc" maxlength="1000"></textarea>
