...
<!--    ------------------------------------------------------------------------->
	...
	<meta charset="utf-8">
	<title>Northern Stylish | Gallery</title>
    ...
    <div class="container-fluid">
        <div class="row align-items-center">
            ...
            <div class="col-6 col-xl-3" data-aos="fade-down">
                <h1 class="mb-0"><a href="index.php" class="text-black h2 mb-0">Beauty Salon</h1>
            </div>
            ...
            <div class="col-6 col-xl-2" data-aos="fade-down">
                <div class="d-none d-xl-inline-block">
                    <div class="d-none d-xl-inline-block">
                        <button style="border-radius: 10px;" type="button" name="login" id="login" class="btn btn-outline-primary btn-sm"><a href = "admin/login.php">Login</button></a>
                    </div>
                </div>
...
?>
	 ...
	 <div class="gallery-text">
		...
		<div class="container">
            ...
            <p><?php echo "$adesc"; ?></p>
				<?php } ?>
                <hr style="border:solid 2px;margin-top:0px;">
